  ...
  return (
    <div className="relative bg-transparent z-20 lg:px-24 px-12">
        <nav className='py-4 flex items-center justify-between'>
                {/* Logo et nom du site */}
                <div className="flex justify-center sm:justify-start gap-1 font-semibold text-lg mb-2">
                ...
                <div className="hidden md:flex space-x-4">
                    <button className="px-4 py-2 border rounded text-white border-blue-500 hover:bg-blue-500 hover:text-white">
                        Register
                    </button>
