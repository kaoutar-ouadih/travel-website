    ...
    return (
        <div className='mx-12 md:mx-24 text-center'>
            <nav className=' p-4 flex items-center justify-between'>
                ...
                <button onClick={()=> navigate("/register")} className="px-4 py-2 border rounded text-blue border-blue-500 hover:bg-blue hover:text-white">
                
                    Register
                    
                    </button>
                    <button onClick={()=> navigate("/sign-in")} className="px-4 py-2 rounded text-white bg-blue hover:bg-white hover:text-blue border border-blue-500">
                        Sign In
                    </button>
                </div>
            </nav>
            {isMenuOpen && (
                <div className="md:hidden bg-white p-4 flex flex-col space-y-4 items-center">
                    <Link to="/" className="text-gray-600 hover:text-black">Home</Link>
                    <Link to="/discover" className="text-gray-600 hover:text-black">Discover</Link>
                    <Link to="/about" className="text-gray-600 hover:text-black">About</Link>
                    <Link to="/contact" className="text-gray-600 hover:text-black">Contact</Link>
