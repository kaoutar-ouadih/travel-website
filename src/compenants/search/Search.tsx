...
const Search = () => {
  ...
  return (
    <div className="absolute -bottom-8 left-1/2 transform -translate-x-1/2 max-w-[85%] lg:max-w-[90%] flex gap-5 flex-col lg:flex-row items-center w-[300px] sm:w-[400px] md:w-[760px] lg:w-[990px] mb-20 p-3 shadow-lg rounded-lg bg-white inset-x-0 mx-auto">
        {/* where are you going */}
