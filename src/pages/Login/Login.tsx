...
const Login = () => {
  return (
    <div className="px-12 md:px-24">
        <div className="flex justify-center sm:justify-start gap-1 font-bold text-lg py-6">
        ...
        <div className="flex flex-col justify-center items-center mt-16 mb-44">
            ...
            <div className="w-[400px]">
                <form>
                    ...
                    <input type="email" className="w-full h-10 mt-2 mb-5 p-3 bg-lightGray" id="email" />
                    <label htmlFor="password" className="block font-semibold">Password</label>
                    <input type="password" className="w-full h-10 mt-2 mb-5 p-3 bg-lightGray" id="password" />
