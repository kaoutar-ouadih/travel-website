...
const SearchBar = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-lightBlue to-darkBlue h-[300px] relative flex justify-center">
      <div className="flex gap-5 flex-col md:flex-row items-center w-[400px] md:w-[760px] lg:w-[990px] mb-20 p-3 shadow-lg rounded-lg mx-auto bg-white absolute md:-bottom-[118px]  -bottom-[160px]">
        {/* where are you going */}
