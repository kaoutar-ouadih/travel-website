  ...
  return (
    <div className="px-24 mt-4">
        <div className="flex gap-5">
            <div className="flex-1 h-[452px]">
                <img src="./assets/product-1-picture1.jpg" alt="product1 picture" className="rounded-md w-full h-full object-cover" />
            </div>
            <div className="w-[400px]">
                    <div>
                        <img src="./assets/product-1-picture2.jpg" alt="product1 picture 2" className="rounded-md w-full" />
                    </div>
                    <div className="mt-4">
                        <img src="./assets/product-1-picture3.jpg" alt="product1 picture 3" className="rounded-md w-full" />
                    </div>
            </div>
        </div>
            ...
            <div className="flex-1">
                ...
                <div className="shadow-xl rounded-lg">
                    ...
                    <div className="p-8 pt-6">
                        ...
                        <div className="flex gap-24 mt-4 text-gray2">
                            <div>
                                <div className="flex gap-3 mb-3">
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9.23051 2.58519L2.87801 7.67269C2.16301 8.24102 1.70467 9.44185 1.86051 10.3402L3.07967 17.6369C3.29967 18.9385 4.54634 19.9927 5.86634 19.9927H16.133C17.4438 19.9927 18.6997 18.9294 18.9197 17.6369L20.1388 10.3402C20.2855 9.44185 19.8272 8.24102 19.1213 7.67269L12.7688 2.59435C11.788 1.80602 10.2022 1.80602 9.23051 2.58519V2.58519Z" stroke="#2F80ED" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M9.05664 13.182C10.2208 12.0728 11.7791 12.0728 12.9433 13.182" stroke="#2F80ED" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M14.886 11.2387C14.4137 10.7746 13.8687 10.3907 13.2727 10.1021C12.5625 9.75822 11.7838 9.57959 10.9948 9.57959C10.2058 9.57959 9.42699 9.75822 8.71685 10.1021C8.14852 10.3771 7.60768 10.7529 7.10352 11.2387" stroke="#2F80ED" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M10.9951 15.5835H11.0035" stroke="#2F80ED" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                                    <span>Free wifi</span>
                                </div>
                                <div className="flex gap-3 mb-3">
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1.8335 13.75H16.9585C18.7277 13.75 20.1668 15.1892 20.1668 16.9583C20.1668 18.7275 18.7277 20.1667 16.9585 20.1667C15.1893 20.1667 13.7502 18.7275 13.7502 16.9583V16.5" stroke="#2F80ED" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/><path d="M1.8335 11.0002H16.9585C18.7185 11.0002 20.1668 9.561 20.1668 7.79183C20.1668 6.03183 18.7185 4.5835 16.9585 4.5835C16.1083 4.58591 15.2937 4.92471 14.6925 5.52587C14.0914 6.12702 13.7526 6.94167 13.7502 7.79183V8.25016" stroke="#2F80ED" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/><path d="M1.8335 8.25003H8.53433C9.02203 8.25003 9.49877 8.10541 9.90427 7.83446C10.3098 7.56351 10.6258 7.1784 10.8125 6.72783C10.9991 6.27726 11.0479 5.78146 10.9528 5.30313C10.8576 4.82481 10.6228 4.38544 10.2779 4.04059C9.93308 3.69573 9.49371 3.46089 9.01539 3.36574C8.53706 3.2706 8.04127 3.31943 7.5907 3.50606C7.14012 3.69269 6.75501 4.00875 6.48406 4.41425C6.21311 4.81975 6.0685 5.2965 6.0685 5.78419V6.13253" stroke="#2F80ED" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/></svg>
                                    <span>Air Conditioning</span>
                                </div>
                                <div className="flex gap-3 mb-3">
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M14.2173 2.59424H7.78234C5.49984 2.59424 4.99567 3.73091 4.70234 5.12424L3.6665 10.0834H18.3332L17.2973 5.12424C17.004 3.73091 16.4998 2.59424 14.2173 2.59424V2.59424Z" stroke="#2F80ED" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M20.1575 18.1685C20.2583 19.241 19.3967 20.1668 18.2967 20.1668H16.5733C15.5833 20.1668 15.4458 19.7452 15.2717 19.2227L15.0883 18.6727C14.8317 17.921 14.6667 17.4168 13.3467 17.4168H8.65334C7.33334 17.4168 7.14084 17.9852 6.91167 18.6727L6.72834 19.2227C6.55417 19.7452 6.41667 20.1668 5.42667 20.1668H3.70334C2.60334 20.1668 1.74167 19.241 1.8425 18.1685L2.35584 12.586C2.48417 11.211 2.75 10.0835 5.15167 10.0835H16.8483C19.25 10.0835 19.5158 11.211 19.6442 12.586L20.1575 18.1685Z" stroke="#2F80ED" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M3.66667 7.3335H2.75" stroke="#2F80ED" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M19.2502 7.3335H18.3335" stroke="#2F80ED" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M11 2.75V4.58333" stroke="#2F80ED" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M9.625 4.5835H12.375" stroke="#2F80ED" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M5.5 13.75H8.25" stroke="#2F80ED" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M13.75 13.75H16.5" stroke="#2F80ED" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
                                    <span>Parking available</span>
                                </div>
                            </div>
                                <div>
                                    <div className="flex gap-3 mb-3">
                                        <svg width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9.00016 16.4168C9.97262 16.4168 10.9053 16.0305 11.5929 15.3429C12.2805 14.6553 12.6668 13.7226 12.6668 12.7502C12.6668 11.7777 12.2805 10.8451 11.5929 10.1574C10.9053 9.4698 9.97262 9.0835 9.00016 9.0835C8.0277 9.0835 7.09507 9.4698 6.40744 10.1574C5.7198 10.8451 5.3335 11.7777 5.3335 12.7502C5.3335 13.7226 5.7198 14.6553 6.40744 15.3429C7.09507 16.0305 8.0277 16.4168 9.00016 16.4168V16.4168Z" stroke="#2F80ED" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/><path d="M7.57031 12.7504L8.16615 13.3462C8.34031 13.5204 8.62448 13.5295 8.79865 13.3554L10.4303 11.8521" stroke="#2F80ED" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M6.25009 19.1668H11.7501C15.4351 19.1668 16.0951 17.691 16.2876 15.8943L16.9751 10.3943C17.2226 8.15766 16.5809 6.3335 12.6668 6.3335H5.33342C1.41925 6.3335 0.777585 8.15766 1.02509 10.3943L1.71259 15.8943C1.90509 17.691 2.56509 19.1668 6.25009 19.1668Z" stroke="#2F80ED" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/><path d="M4.875 6.03108V5.14191C4.875 3.07941 6.53417 1.05357 8.59667 0.861075C9.16974 0.804771 9.74826 0.869076 10.295 1.04985C10.8417 1.23063 11.3445 1.52387 11.7711 1.9107C12.1976 2.29753 12.5385 2.76939 12.7717 3.2959C13.0048 3.82241 13.1252 4.39191 13.125 4.96774V6.23274" stroke="#2F80ED" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/></svg>
                                        <span>Business Services</span>
                                    </div>
                                    <div className="flex gap-3 mb-3">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9.97233 19.1668C15.0351 19.1668 19.139 15.0629 19.139 10.0002C19.139 4.93741 15.0351 0.833496 9.97233 0.833496C4.90958 0.833496 0.805664 4.93741 0.805664 10.0002C0.805664 15.0629 4.90958 19.1668 9.97233 19.1668V19.1668Z" stroke="#2F80ED" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M10 14.125C11.094 14.125 12.1432 13.6904 12.9168 12.9168C13.6904 12.1432 14.125 11.094 14.125 10C14.125 8.90598 13.6904 7.85677 12.9168 7.08318C12.1432 6.3096 11.094 5.875 10 5.875C8.90598 5.875 7.85677 6.3096 7.08318 7.08318C6.3096 7.85677 5.875 8.90598 5.875 10C5.875 11.094 6.3096 12.1432 7.08318 12.9168C7.85677 13.6904 8.90598 14.125 10 14.125V14.125Z" stroke="#2F80ED" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M3.49121 3.51953L6.73621 6.75536" stroke="#2F80ED" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M3.4917 16.4809L6.7367 13.2451" stroke="#2F80ED" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M16.4623 16.4809L13.2173 13.2451" stroke="#2F80ED" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M16.4623 3.51953L13.2173 6.75536" stroke="#2F80ED" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
                                        <span>Swimming pool</span>
                                    </div>
                                    <div className="flex gap-3 mb-3">
                                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M6.85645 16.8208L9.69811 19.0208C10.0648 19.3874 10.8898 19.5708 11.4398 19.5708H14.9231C16.0231 19.5708 17.2148 18.7458 17.4898 17.6458L19.6898 10.9541C20.1481 9.67076 19.3231 8.57076 17.9481 8.57076H14.2814C13.7314 8.57076 13.2731 8.11243 13.3648 7.47076L13.8231 4.53743C14.0064 3.71243 13.4564 2.79576 12.6314 2.52076C11.8981 2.24576 10.9814 2.61243 10.6148 3.16243L6.85645 8.7541" stroke="#2F80ED" stroke-width="1.5" stroke-miterlimit="10"/><path d="M2.18164 16.8207V7.83737C2.18164 6.55404 2.73164 6.0957 4.01497 6.0957H4.93164C6.21497 6.0957 6.76497 6.55404 6.76497 7.83737V16.8207C6.76497 18.104 6.21497 18.5624 4.93164 18.5624H4.01497C2.73164 18.5624 2.18164 18.104 2.18164 16.8207Z" stroke="#2F80ED" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
                ...
                <div className="w-[400px]"> 
                    <div>
                        <img src="./assets/location-on-map.png" alt="the location on the map"/>
                    </div>
                    <div>
